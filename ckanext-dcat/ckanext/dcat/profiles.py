...
log = logging.getLogger('ckanext.dcat')
...
DIGST = Namespace('http://terms.digst.dk/')
...
#                ('identifier', DCT.identifier),
                ...
                ('dcat_type', DCT.type),
                ('payment_required', DIGST.paymentRequired),
                ('personalData', DIGST.personalData),
                ('legalBasis', DIGST.legalBasis),
                ('confidential', DIGST.confidential),
                ):
            value = self._object_value(dataset_ref, predicate)
            log.error("AAA");
            if value:
...
#            ('identifier', DCT.identifier, ['guid', 'id'], Literal),
            ...
            ('payment_required', DIGST.paymentRequired, None, Literal),
            ('personalData', DIGST.personalData, None, Literal),
            ('legalBasis', DIGST.legalBasis , None, Literal),
            ('confidential', DIGST.confidential, None, Literal),
        ]
